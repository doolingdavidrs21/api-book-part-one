...
from .schemas import League, Team, Player, Counts, Performance
...
class SWCClient:
    ...
    Fantasty Football API. It supports all the functions of the
    SWC API and returns validated data types.
    ...
    LIST_COUNTS_ENDPOINT = "/v0/counts/"

    BULK_FILE_BASE_URL = (
        "https://raw.githubusercontent.com/doolingdavidrs21"
