"""SQLAlchemy Query Functions - Adapted for AutoModels"""
from sqlalchemy.orm import Session
from sqlalchemy.orm import joinedload
from datetime import date

# CHANGE 1: Import your auto-generated file, but alias it as 'models'
# so we don't have to rewrite every line below.
import automodels as models
...
def get_leagues(db: Session, skip: int = 0, limit: int = 100,
    ...
    # CHANGE 2: The auto-generator named the relationship 'team' (singular),
    # whereas the book named it 'teams' (plural). We must match automodels.py.
    query = db.query(models.League).options(joinedload(models.League.team))
